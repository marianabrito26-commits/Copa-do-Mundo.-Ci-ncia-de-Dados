...
<head>
 ...
 <table id="tabela">
   ...
   <tr><td><input type="text" value="Alemanha"></td><td><input type="number" value="15"></td></tr><tr><td><input type="text" value="Portugal"></td><td><input type="number" value="10"></td></tr>
   </table>
